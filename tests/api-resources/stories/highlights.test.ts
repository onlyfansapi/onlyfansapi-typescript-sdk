...
describe('resource highlights', () => {
  ...
  test.skip('addStory: only required params', async () => {
    const responsePromise = client.stories.highlights.addStory('esse', {
      account: 'acct_XXXXXXXXXXXXXXX',
  ...
  test.skip('addStory: required and optional params', async () => {
    const response = await client.stories.highlights.addStory('esse', {
      account: 'acct_XXXXXXXXXXXXXXX',
      highlight_id: 1234567890,
      story_id: 2345678901,
    });
  ...
  test.skip('removeStory: only required params', async () => {
    const responsePromise = client.stories.highlights.removeStory('esse', {
      account: 'acct_XXXXXXXXXXXXXXX',
      highlight_id: 1234567890,
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('removeStory: required and optional params', async () => {
    const response = await client.stories.highlights.removeStory('esse', {
      account: 'acct_XXXXXXXXXXXXXXX',
      highlight_id: 1234567890,
    });
  });
