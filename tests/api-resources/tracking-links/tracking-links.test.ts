...
describe('resource trackingLinks', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.trackingLinks.retrieve('totam', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.trackingLinks.retrieve('totam', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.trackingLinks.delete('totam', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.trackingLinks.delete('totam', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('getStats: only required params', async () => {
    const responsePromise = client.trackingLinks.getStats('laborum', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getStats: required and optional params', async () => {
    const response = await client.trackingLinks.getStats('laborum', {
      account: 'acct_XXXXXXXXXXXXXXX',
