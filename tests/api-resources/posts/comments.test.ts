...
describe('resource comments', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.posts.comments.create('blanditiis', {
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.posts.comments.create('blanditiis', {
      account: 'acct_XXXXXXXXXXXXXXX',
      text: 'This is a comment.',
      answerTo: 123,
      giphyId: 'giphy123',
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.posts.comments.list('blanditiis', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.posts.comments.list('blanditiis', {
      account: 'acct_XXXXXXXXXXXXXXX',
      limit: 10,
      offset: 0,
      sort: 'desc',
