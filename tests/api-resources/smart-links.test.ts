...
describe('resource smartLinks', () => {
  ...
  test.skip('listConversions', async () => {
    const responsePromise = client.smartLinks.listConversions('nemo');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listFans', async () => {
    const responsePromise = client.smartLinks.listFans('ab');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listSpenders', async () => {
    const responsePromise = client.smartLinks.listSpenders('nobis');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
