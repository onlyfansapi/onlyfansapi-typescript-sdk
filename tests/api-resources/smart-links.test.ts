...
describe('resource smartLinks', () => {
  ...
  test.skip('listClicks', async () => {
    const responsePromise = client.smartLinks.listClicks('rem');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listConversions', async () => {
    const responsePromise = client.smartLinks.listConversions('vitae');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listSpenders', async () => {
    const responsePromise = client.smartLinks.listSpenders('saepe');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveStats', async () => {
    const responsePromise = client.smartLinks.retrieveStats('sed');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
