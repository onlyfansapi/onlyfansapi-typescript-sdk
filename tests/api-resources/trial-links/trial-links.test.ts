...
describe('resource trialLinks', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.trialLinks.retrieve('nemo', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.trialLinks.retrieve('nemo', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.trialLinks.delete('nemo', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.trialLinks.delete('nemo', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('listSubscribers: only required params', async () => {
    const responsePromise = client.trialLinks.listSubscribers('nisi', {
      account: 'acct_XXXXXXXXXXXXXXX',
      limit: 10,
      offset: 0,
    });
  ...
  test.skip('listSubscribers: required and optional params', async () => {
    const response = await client.trialLinks.listSubscribers('nisi', {
      account: 'acct_XXXXXXXXXXXXXXX',
      limit: 10,
      offset: 0,
    });
