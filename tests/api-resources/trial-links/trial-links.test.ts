...
describe('resource trialLinks', () => {
  ...
  test.skip('retrieveCohortArps: only required params', async () => {
    const responsePromise = client.trialLinks.retrieveCohortArps('quibusdam', {
      account: 'acct_XXXXXXXXXXXXXXX',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('retrieveCohortArps: required and optional params', async () => {
    const response = await client.trialLinks.retrieveCohortArps('quibusdam', {
      account: 'acct_XXXXXXXXXXXXXXX',
  ...
  test.skip('retrieveStats: only required params', async () => {
    const responsePromise = client.trialLinks.retrieveStats('suscipit', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveStats: required and optional params', async () => {
    const response = await client.trialLinks.retrieveStats('suscipit', {
      account: 'acct_XXXXXXXXXXXXXXX',
