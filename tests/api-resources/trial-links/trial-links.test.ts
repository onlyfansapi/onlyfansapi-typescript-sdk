...
describe('resource trialLinks', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.trialLinks.retrieve('ipsum', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.trialLinks.retrieve('ipsum', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.trialLinks.delete('ipsum', { account: 'acct_XXXXXXXXXXXXXXX' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.trialLinks.delete('ipsum', { account: 'acct_XXXXXXXXXXXXXXX' });
  });
  ...
  test.skip('listSubscribers: only required params', async () => {
    const responsePromise = client.trialLinks.listSubscribers('repellat', {
      account: 'acct_XXXXXXXXXXXXXXX',
      limit: 10,
      offset: 0,
    });
  ...
  test.skip('listSubscribers: required and optional params', async () => {
    const response = await client.trialLinks.listSubscribers('repellat', {
      account: 'acct_XXXXXXXXXXXXXXX',
      limit: 10,
      offset: 0,
    });
  ...
  test.skip('retrieveStats: only required params', async () => {
    const responsePromise = client.trialLinks.retrieveStats('asperiores', {
      account: 'acct_XXXXXXXXXXXXXXX',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('retrieveStats: required and optional params', async () => {
    const response = await client.trialLinks.retrieveStats('asperiores', {
      account: 'acct_XXXXXXXXXXXXXXX',
