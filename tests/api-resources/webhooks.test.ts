...
describe('resource webhooks', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.webhooks.retrieve('wh_abc123');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.webhooks.update('wh_abc123', {
      account_scope: 'global',
      endpoint_url: 'https://example.com',
      events: ['accounts.connected', 'subscriptions.new'],
    });
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.webhooks.update('wh_abc123', {
      account_scope: 'global',
      endpoint_url: 'https://example.com',
      events: ['accounts.connected', 'subscriptions.new'],
      account_ids: ['ac_abc123'],
  ...
  test.skip('delete', async () => {
    const responsePromise = client.webhooks.delete('wh_abc123');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
