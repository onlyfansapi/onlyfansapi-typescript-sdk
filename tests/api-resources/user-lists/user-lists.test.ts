...
describe('resource userLists', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.userLists.create('acct_XXXXXXXXXXXXXXX', { name: 'uwshox' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.userLists.create('acct_XXXXXXXXXXXXXXX', { name: 'uwshox' });
  });
