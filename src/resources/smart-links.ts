...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('qui');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listSpenders('ex');
   * ```
   */
  listSpenders(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('modi');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
