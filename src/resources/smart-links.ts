...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('illo');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listSpenders('id');
   * ```
   */
  listSpenders(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('iusto');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
