...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('hic');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listSpenders('at');
   * ```
   */
  listSpenders(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('fugiat');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
