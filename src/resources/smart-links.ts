...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listClicks('vel');
   * ```
   */
  listClicks(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('velit');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('sint');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
