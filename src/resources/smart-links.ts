...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listClicks('quas');
   * ```
   */
  listClicks(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('aut');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('corrupti');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
