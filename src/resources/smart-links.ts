...
export class SmartLinks extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listClicks('nam');
   * ```
   */
  listClicks(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * const response = await client.smartLinks.listFans('et');
   * ```
   */
  listFans(
    smartLinkID: string,
   ...
   * @example
   * ```ts
   * await client.smartLinks.retrieveCohortArps('saepe');
   * ```
   */
  retrieveCohortArps(
    smartLinkID: string,
