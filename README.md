...
[![NPM version](<https://img.shields.io/npm/v/@onlyfansapi/onlyfans-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@onlyfansapi/onlyfans-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@onlyfansapi/onlyfans-sdk)
...
await client.media.upload('acct_XXXXXXXXXXXXXXX', { file: new File(['my bytes'], 'file') });

// You can also pass a `fetch` `Response`:
await client.media.upload('acct_XXXXXXXXXXXXXXX', { file: await fetch('https://somesite/file') });

// Finally, if none of the above are convenient, you can use our `toFile` helper:
await client.media.upload('acct_XXXXXXXXXXXXXXX', {
...
```ts
import OnlyFansAPI from 'npm:@onlyfansapi/onlyfans-sdk';
